...
try {
  components = {
    ...
    liuCountdown: function () {
      return __webpack_require__.e(/*! import() | uni_modules/liu-countdown/components/liu-countdown/liu-countdown */ "uni_modules/liu-countdown/components/liu-countdown/liu-countdown").then(__webpack_require__.bind(null, /*! @/uni_modules/liu-countdown/components/liu-countdown/liu-countdown.vue */ 301))
    },
...
var _default = {
  ...
  methods: {
    ...
    getCommodityList: function getCommodityList(id, pusData) {
      var _this2 = this;
      this.$http("/my-merchandise/commodity/list", {
        wxMenuId: id,
        page: 1,
